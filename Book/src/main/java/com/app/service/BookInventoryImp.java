...
public class BookInventoryImp implements BookInventoryInf{
	 ...
	 */
	@Override
	public BookInventory getBookInventoryById(int bookInventoryId){
		return bookInventoryRepository.findById(bookInventoryId).orElseThrow(() -> new BookException(HttpStatus.NOT_FOUND,"Invalid book inventory id"));
	}
	/**
